...
public class BlobStorageCopy {
    public static void main(String[] args) {
        ...
        if (args.length < 3) {
            System.out.println("Not enough parameters. Proper Usage is: java -jar azureblobstoragecopy.jar <SOURCE_CONTAINER> <SOURCE_FILE> <DESTINATION_CONTAINER>");
            System.exit(1);
        }
        ...
        try
        {
            ...
            if (waitForCopyToComplete(destinationBlob) == CopyStatus.SUCCESS) {
                ...
                System.out.println("Not successfully copied the blob.");
            }
        }
        catch (Exception e)
        {
