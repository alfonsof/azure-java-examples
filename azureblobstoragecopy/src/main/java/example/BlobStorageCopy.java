...
public class BlobStorageCopy {
    public static void main(String[] args) {
        ...
        // Copy a Blob from a Blob Storage container to another Blob Storage container.
        copyBlob(storageConnectionString, sourceContainerName, sourceBlobName, destinationContainerName);
    }
     ...
     * Copy a Blob from a Blob Storage container to another Blob Storage container.
     */
    private static void copyBlob(String storageConnectionString,
            ...
            if (sourceContainerClient.exists()) {
                ...
                if (sourceBlobClient.exists()) {
                    ...
                    if (destinationContainerClient.exists()) {
                        ...
                        System.out.println(String.format("\nCopying Blob: \"%s\"", sourceBlobClient.getBlobUrl()));
