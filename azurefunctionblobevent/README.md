# Azure Function Blob Storage event Java example
...
* Create the Azure Funtion project and the Azure Function (Boilerplate code)
  ...
  * artifactId: azurefunctionblobevent
  * version: 1.0.0
  * package: example
  * trigger: BlobTrigger

  Then, the project is created with `azurefunctionblobevent` and these files:
